...
void Axis::Init()
{
    ...
    mag_radian_offset = atan2(yMag, xMag);
}
//=====================================================================================//
void Axis::Accl()
{
...
void Axis::Gyro()
{
    ...
    gyro_radian += ((zGyro + prezGyro) * float(time - preMicros) / 2000000) * PI / 180.0;
    preMicros = time;
    prezGyro = zGyro;
}
//=====================================================================================//
void Axis::Mag()
{
    ...
    mag_radian = atan2(yMag, xMag) - mag_radian_offset;
}

float Axis::Angle()
{
    int _degree = int(gyro_radian * 180.0 / PI);
    _degree += 180;
    _degree %= 360;
    if (_degree < 0)
    {
